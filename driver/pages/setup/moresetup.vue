	...
	<view class="content">
			...
			<view class="dui-basic-list-item">
				<view class="dui-basic-list-item__container dui-reduce">
					<view class="dui-basic-list-item__content">
						<view class="dui-basic-list-item__content-title">音效提示</view>
						<view class="dui-basic-list-item__content-note">打开后将以予语音为你播报订单状态</view>
					</view>
					<view class="dui-basic-list-item__extra"><switch checked color="#FF5723" style="transform:scale(0.7)" @change="switchChange" /></view>
				</view>
			</view>
		</view>
		<view class="dui-gap"></view>
		...
		<view class="dui-basic-list">
			<navigator url="clause">
				<view class="dui-basic-list-item">
					<view class="dui-basic-list-item__container">
						<view class="dui-basic-list-item__content"><view class="dui-basic-list-item__content-title">服务条款</view></view>
						<view class="dui-basic-list-item__extra"><text class="iconfont icon-gengduo-shuxiang"></text></view>
					</view>
				</view>
			</navigator>
			<navigator :url="'/pages/setup/aview?title=司机使用协议&scode=' + $drmking.md5('司机使用协议')">
				<view class="dui-basic-list-item">
					<view class="dui-basic-list-item__container">
						<view class="dui-basic-list-item__content"><view class="dui-basic-list-item__content-title">司机使用协议</view></view>
						<view class="dui-basic-list-item__extra"><text class="iconfont icon-gengduo-shuxiang"></text></view>
					</view>
				</view>
			</navigator>
			<navigator :url="'/pages/setup/aview?title=软件使用协议&scode=' + $drmking.md5('软件使用协议')">
				<view class="dui-basic-list-item">
					<view class="dui-basic-list-item__container">
						<view class="dui-basic-list-item__content"><view class="dui-basic-list-item__content-title">软件使用协议</view></view>
						<view class="dui-basic-list-item__extra"><text class="iconfont icon-gengduo-shuxiang"></text></view>
					</view>
				</view>
			</navigator>
			<navigator :url="'/pages/setup/aview?title=货物托运居间协议&scode=' + $drmking.md5('货物托运居间协议')">
				<view class="dui-basic-list-item">
					<view class="dui-basic-list-item__container">
						<view class="dui-basic-list-item__content"><view class="dui-basic-list-item__content-title">货物托运居间协议</view></view>
						<view class="dui-basic-list-item__extra"><text class="iconfont icon-gengduo-shuxiang"></text></view>
					</view>
				</view>
			</navigator>
			<navigator :url="'/pages/setup/aview?title=个人隐私条款&scode=' + $drmking.md5('个人隐私条款')">
				<view class="dui-basic-list-item">
					<view class="dui-basic-list-item__container">
						<view class="dui-basic-list-item__content"><view class="dui-basic-list-item__content-title">个人隐私条款</view></view>
						<view class="dui-basic-list-item__extra"><text class="iconfont icon-gengduo-shuxiang"></text></view>
					</view>
				</view>
			</navigator>
