...
var x=['./components/m-icon/m-icon.wxml','./components/m-input.wxml','./pages/index/index.wxml','./pages/login/login.wxml','./pages/order/order.wxml','./pages/pwd/pwd.wxml','./pages/reg/reg.wxml','./pages/user/user.wxml'];d_[x[0]]={}
...
_(oBB,lCB)
var aDB=_mz(z,'m-input',['clearable',-1,'focus',-1,'bind:__l',6,'bind:input',1,'class',2,'data-event-opts',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(oBB,aDB)
_(cAB,oBB)
var tEB=_n('view')
...
_(t7B,e8B)
var b9B=_mz(z,'m-input',['clearable',-1,'focus',-1,'bind:__l',6,'bind:input',1,'class',2,'data-event-opts',3,'placeholder',4,'type',5,'value',6,'vueId',7],[],e,s,gg)
_(t7B,b9B)
_(a6B,t7B)
var o0B=_n('view')
...
var fCC=_mz(z,'input',['clearable',-1,'bindinput',17,'data-event-opts',1,'maxlength',2,'placeholder',3,'type',4,'value',5],[],e,s,gg)
_(oBC,fCC)
_(o0B,oBC)
var cDC=_mz(z,'button',['bindtap',23,'class',1,'data-event-opts',2,'disabled',3,'type',4],[],e,s,gg)
var hEC=_oz(z,28,e,s,gg)
_(cDC,hEC)
_(o0B,cDC)
_(a6B,o0B)
var oFC=_n('view')
...
_(oFC,cGC)
var oHC=_mz(z,'m-input',['displayable',-1,'bind:__l',31,'bind:input',1,'data-event-opts',2,'placeholder',3,'type',4,'value',5,'vueId',6],[],e,s,gg)
_(oFC,oHC)
_(a6B,oFC)
var lIC=_n('view')
...
var eLC=_mz(z,'input',['displayable',-1,'bindinput',41,'data-event-opts',1,'placeholder',2,'type',3,'value',4],[],e,s,gg)
_(tKC,eLC)
_(lIC,tKC)
_(a6B,lIC)
_(o4B,a6B)
...
var oNC=_mz(z,'button',['bindtap',47,'class',1,'data-event-opts',2,'type',3],[],e,s,gg)
...
_(oTC,cUC)
var oVC=_mz(z,'m-input',['clearable',-1,'focus',-1,'bind:__l',5,'bind:input',1,'data-event-opts',2,'placeholder',3,'type',4,'value',5,'vueId',6],[],e,s,gg)
_(oTC,oVC)
_(hSC,oTC)
var lWC=_n('view')
...
var eZC=_mz(z,'input',['clearable',-1,'bindinput',15,'data-event-opts',1,'maxlength',2,'placeholder',3,'type',4,'value',5],[],e,s,gg)
_(tYC,eZC)
_(lWC,tYC)
var b1C=_mz(z,'button',['bindtap',21,'class',1,'data-event-opts',2,'disabled',3,'type',4],[],e,s,gg)
var o2C=_oz(z,26,e,s,gg)
_(b1C,o2C)
_(lWC,b1C)
_(hSC,lWC)
var x3C=_n('view')
...
_(x3C,o4C)
var f5C=_mz(z,'m-input',['displayable',-1,'bind:__l',29,'bind:input',1,'data-event-opts',2,'placeholder',3,'type',4,'value',5,'vueId',6],[],e,s,gg)
_(x3C,f5C)
_(hSC,x3C)
_(fQC,hSC)
var c6C=_n('view')
_rz(z,c6C,'class',36,e,s,gg)
var h7C=_mz(z,'button',['bindtap',37,'class',1,'data-event-opts',2,'type',3],[],e,s,gg)
...
__wxAppCode__['pages/user/user.wxss']=setCssToHead([".",[1],"dui-user-bj { position: absolute; top: ",[0,-4750],"; left: 50%; width: ",[0,5200],"; height: ",[0,5200],"; border-radius: 50%; background-color: #292b3a; -webkit-transform: translateX(-50%); -ms-transform: translateX(-50%); transform: translateX(-50%); }\n",],undefined,{path:"./pages/user/user.wxss"});    
