...
var x=['./components/drawer/drawer.wxml','./components/m-icon/m-icon.wxml','./components/m-input.wxml','./components/uni-icons/uni-icons.wxml','./components/uni-indexed-list/uni-indexed-list.wxml','./pages/cardetail/cardetail.wxml','./pages/index/index.wxml','./pages/login/login.wxml','./pages/map/map.wxml','./pages/orderlist/orderlist.wxml','./pages/pwd/pwd.wxml','./pages/reg/reg.wxml','./pages/small-van/small-van.wxml','./pages/user/user.wxml'];d_[x[0]]={}
...
var t7B=_n('image')
_rz(z,t7B,'src',4,c3B,o2B,gg)
_(a6B,t7B)
_(o4B,a6B)
return o4B
}
cZB.wxXCkey=2
_2z(z,2,h1B,e,s,gg,cZB,'item','__i0__','id')
_(oXB,fYB)
var e8B=_n('view')
...
var oNC=_n('view')
_rz(z,oNC,'class',18,tKC,aJC,gg)
var xOC=_n('text')
_rz(z,xOC,'class',19,tKC,aJC,gg)
_(oNC,xOC)
var oPC=_n('text')
var fQC=_oz(z,20,tKC,aJC,gg)
_(oPC,fQC)
_(oNC,oPC)
_(eLC,oNC)
return eLC
...
oHC.wxXCkey=2
_2z(z,16,lIC,e,s,gg,oHC,'item','__i1__','id')
_(oXB,hEC)
_(r,oXB)
return r
}
...
var o8F=_mz(z,'m-button',['bind:__l',24,'bindtap',1,'data-event-opts',2,'text',3,'vueId',4],[],e,s,gg)
_(x7F,o8F)
_(cVF,x7F)
var f9F=_n('view')
_rz(z,f9F,'class',29,e,s,gg)
var c0F=_n('navigator')
_rz(z,c0F,'url',30,e,s,gg)
var hAG=_oz(z,31,e,s,gg)
_(c0F,hAG)
_(f9F,c0F)
var oBG=_n('text')
var cCG=_oz(z,32,e,s,gg)
_(oBG,cCG)
_(f9F,oBG)
var oDG=_n('navigator')
_rz(z,oDG,'url',33,e,s,gg)
...
var aFG=_mz(z,'view',['class',36,'style',1],[],e,s,gg)
var tGG=_v()
_(aFG,tGG)
var eHG=function(oJG,bIG,xKG,gg){
var fMG=_n('view')
_rz(z,fMG,'class',42,oJG,bIG,gg)
var cNG=_mz(z,'image',['bindtap',43,'data-event-opts',1,'src',2],[],oJG,bIG,gg)
_(fMG,cNG)
_(xKG,fMG)
return xKG
}
tGG.wxXCkey=2
_2z(z,40,eHG,e,s,gg,tGG,'provider','__i0__','value')
_(hWF,aFG)
}
hWF.wxXCkey=1
_(r,cVF)
...
var oZG=_mz(z,'view',['bindtap',6,'class',1,'data-current',2,'data-event-opts',3],[],bWG,eVG,gg)
...
aTG.wxXCkey=2
_2z(z,4,tUG,e,s,gg,aTG,'item','index','index')
_(oRG,lSG)
var c2G=_mz(z,'swiper',['bindchange',11,'current',1,'data-event-opts',2],[],e,s,gg)
...
_(cFH,hGH)
var oHH=_mz(z,'m-input',['focus',-1,'clearable',-1,'bind:__l',5,'bind:input',1,'data-event-opts',2,'placeholder',3,'type',4,'value',5,'vueId',6],[],e,s,gg)
_(cFH,oHH)
_(fEH,cFH)
_(oDH,fEH)
var cIH=_n('view')
_rz(z,cIH,'class',12,e,s,gg)
var oJH=_mz(z,'m-button',['bind:__l',13,'bindtap',1,'data-event-opts',2,'text',3,'vueId',4],[],e,s,gg)
_(cIH,oJH)
_(oDH,cIH)
_(r,oDH)
return r
...
_(eNH,bOH)
var oPH=_mz(z,'m-input',['focus',-1,'clearable',-1,'bind:__l',4,'bind:input',1,'data-event-opts',2,'placeholder',3,'type',4,'value',5,'vueId',6],[],e,s,gg)
_(eNH,oPH)
_(tMH,eNH)
var xQH=_n('view')
...
_(xQH,oRH)
var fSH=_mz(z,'m-input',['displayable',-1,'bind:__l',13,'bind:input',1,'data-event-opts',2,'placeholder',3,'type',4,'value',5,'vueId',6],[],e,s,gg)
_(xQH,fSH)
_(tMH,xQH)
var cTH=_n('view')
...
_(cTH,hUH)
var oVH=_mz(z,'m-input',['clearable',-1,'bind:__l',22,'bind:input',1,'data-event-opts',2,'placeholder',3,'type',4,'value',5,'vueId',6],[],e,s,gg)
_(cTH,oVH)
_(tMH,cTH)
_(aLH,tMH)
var cWH=_n('view')
_rz(z,cWH,'class',29,e,s,gg)
var oXH=_mz(z,'m-button',['bind:__l',30,'bindtap',1,'data-event-opts',2,'text',3,'vueId',4],[],e,s,gg)
_(cWH,oXH)
_(aLH,cWH)
_(r,aLH)
return r
...
var xII=_n('view')
_rz(z,xII,'class',12,eFI,tEI,gg)
var oJI=_n('text')
_rz(z,oJI,'class',13,eFI,tEI,gg)
_(xII,oJI)
var fKI=_n('text')
var cLI=_oz(z,14,eFI,tEI,gg)
_(fKI,cLI)
_(xII,fKI)
_(bGI,xII)
return bGI
...
lCI.wxXCkey=2
_2z(z,11,aDI,e,s,gg,lCI,'item','__i0__','')
_(aZH,o0H)
_(r,aZH)
return r
}
...
var aRI=_mz(z,'button',['bindtap',3,'class',1,'data-event-opts',2,'type',3],[],e,s,gg)
...
var lQI=_v()
_(cOI,lQI)
if(_oz(z,8,e,s,gg)){lQI.wxVkey=1
var eTI=_mz(z,'button',['bindtap',9,'data-event-opts',1,'type',2],[],e,s,gg)
