<template>
	<view class="content">
					...
					<view class="dui-basic-list-item">
						<view class="dui-basic-list-item__container">
							<view class="dui-basic-list-item__content">
								...
								<view class="dui-basic-list-item__content-note">{{ item.address }}</view>
								<view class="dui-basic-list-item__content-note">{{ item.name + item.address_phone }}</view>
							</view>
						</view>
					</view>
				</navigator>
		...
		<view class="dui-fixed-bottom-btn">
			<navigator url="addaddress"><button class="primary" type="primary">添加常用地址</button></navigator>
		</view>
	</view>
</template>
