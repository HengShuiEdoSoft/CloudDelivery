    ...
    <view class="content">
		...
		<view class="ui-car-select">
			<view class="ui-car-name-list">
				<view class="ui-car-name-item" v-for="(item,index) in carTypes" :key="item.car_id" :class="{active:current==index}" :data-current="index" @tap="tabChange">{{item.car_title}}</view>
			</view>
					...
					<swiper-item class="ui-carinfo-item" v-for="(item,index) in carTypes" :key="item.car_id">
						<view class="ui-carinfo-body">
							...
							<view class="ui-carinfo-cont">
								...
								<view>长宽高：<text>{{item.car_lenght}}</text>*<text>{{item.car_width}}</text>*<text>{{item.car_height}}米</text></view>
