	...
	<view class="content">
		...
		<view class="input-group dui-input-group-mg">
			...
			<view class="input-row border">
				...
				<view class="dui-input"><m-input type="text" v-model="vercode" placeholder="请输入验证码" maxlength="6"></m-input></view>
		...
		<view class="btn-row"><button class="primary" type="primary" @tap="register(regurl)">注 册</button></view>
	</view>
</template>
