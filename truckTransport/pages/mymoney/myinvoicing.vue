<template>
	<view class="content">
		...
		<view class="dui-basic-tips">
			...
			1.增值税普通电子发票将于3个工作日内为您开具并发送至您预留的邮箱 <br>
			2.增值税纸质专用发票申请处理后，将于5个工作日内为您寄出<br>
			3.行程中消费的各种形式的折扣、券金额及赠送金额不支持开票，普票仅可开具增值税普通电子发票<br>
			4.开具专票满1000元及以上，我们将为您包邮；未满1000元的快递费将由您自行承担，相应金额的快递费将从您的账户余额中自动扣除<br>
			5.如未收到，请在纸质发票快递签收后24小时内联系货拉拉客服<br>
			6.因您个人填写快递信息有误等原因产生的发票退票及重寄的往来费用，需由您自行承担<br>
			7.为响应国家税务总局关于推行电子发票的号召，建议您选择开具电子发票
		</view>
	</view>
</template>
<script>
